...
public class LaptopAndNotebookPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() {
        ...
        new CheckoutPage().enterLastName("Pate");
        new CheckoutPage().enterEmailId("Prime123");
        new CheckoutPage().enterTelephone("0785251683346");
        new CheckoutPage().enterAddressLine1("canrbury road");
        new CheckoutPage().enterCity("Harrow");
        new CheckoutPage().enterPostCode("Ha3 5tb");
        new CheckoutPage().selectCountry("United Kingdom");
        new CheckoutPage().selectRegion("England");
    ...
    public void iAddCommentsToTextAreaAboutProductOrder() {
        new CheckoutPage().addCommentsToTextArea("");
    }
