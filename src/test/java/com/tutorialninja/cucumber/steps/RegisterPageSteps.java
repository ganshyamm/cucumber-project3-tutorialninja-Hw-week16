...
public class RegisterPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfRegistration() {
        ...
        new RegisterPage().enterLastName("test123");
        new RegisterPage().enterEmail("prime"+ Utility.getRandomString(4)+"@gmail.com");
        new RegisterPage().enterTelephone("07547879809");
        new RegisterPage().enterPassword("tester13");
        new RegisterPage().enterConfirmPassword("tester13");
